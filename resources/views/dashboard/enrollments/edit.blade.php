                    ...
                    <div class=" border border-lgreen rounded-md">
                        ...
                        <div class="px-5 py-3 relative">
                            ...
                            <div class="mt-2 flex justify-between items-end">
                                ...
                                <div class="">
                                    <p class=" text-lg font-bold text-white bg-dgreen px-3 py-1 rounded-full"> {{number_format($enrollmentitem->course->current_price, 0) }} BDT</p>
                                </div>
                            </div>
                            ...
                            <div class="mt-4">
                                <p>Enrollment Status:
                                    ...
                                    <span class="text-xs text-white bg-dgreen px-2 py-1 rounded-full"> Approved</span>
                                    @endif
                                </p>
